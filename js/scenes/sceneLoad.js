class SceneLoad extends Phaser.Scene {
    ...
    this.load.audio("lose", ['audio/sounds/lose.wav', 'audio/sounds/lose.ogg'])
    this.load.audio("flip", ['audio/sounds/flip.wav', 'audio/sounds/flip.ogg'])
    this.load.audio("hit", ['audio/sounds/hit.wav', 'audio/sounds/hit.ogg'])
